...
def generate_grade_distbution_dict(all_offerings):
    ...
    distribution = []
    distribution.append({'A+':int(total_Apls)})
    distribution.append({'A':int(total_A)})
    distribution.append({'A-':int(total_Amin)})
    distribution.append({'B+':int(total_Bpls)})
    distribution.append({'B':int(total_B)})
    distribution.append({'B-':int(total_Bmin)})
    distribution.append({'C+':int(total_Cpls)})
    distribution.append({'C':int(total_C)})
    distribution.append({'C-':int(total_Cmin)})
    distribution.append({'D+':int(total_Dpls)})
    distribution.append({'D':int(total_D)})
    distribution.append({'D-':int(total_Dmin)})
    distribution.append({'F':int(total_F)})
